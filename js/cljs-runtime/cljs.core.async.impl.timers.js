...
var i_38870 = (0);
while(true){
if((i_38870 < arr.length)){
(arr[i_38870] = null);

var G__38871 = (i_38870 + (1));
i_38870 = G__38871;
continue;
} else {
}
...
var i_38881 = (self__.level + (1));
while(true){
if((i_38881 <= (new_level + (1)))){
(update[i_38881] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_38883 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_38883[i]));
} else {
x__$2.forward.push((((i < links_38883.length))?(links_38883[i]):null));
}

if((i < links_38883.length)){
(links_38883[i] = x__$2);
} else {
links_38883.push(x__$2);
}
...
var i_38911 = (0);
while(true){
if((i_38911 <= self__.level)){
var links_38912 = (update[i_38911]).forward;
if((x__$1 === (((i_38911 < links_38912.length))?(links_38912[i_38911]):null))){
(links_38912[i_38911] = (x__$1.forward[i_38911]));

var G__38913 = (i_38911 + (1));
i_38911 = G__38913;
continue;
} else {
var G__38914 = (i_38911 + (1));
i_38911 = G__38914;
continue;
}
} else {
...
var G__38928 = nx;
var G__38929 = (level__$1 - (1));
x = G__38928;
level__$1 = G__38929;
continue;
} else {
var G__38935 = x;
var G__38936 = (level__$1 - (1));
x = G__38935;
level__$1 = G__38936;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__38943 = nx;
var G__38945 = (level__$1 - (1));
x = G__38943;
level__$1 = G__38945;
continue;
} else {
var G__38949 = x;
var G__38950 = (level__$1 - (1));
x = G__38949;
level__$1 = G__38950;
continue;
}
