...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35861 = c;
var G__35861__$1 = (((G__35861 == null))?null:G__35861.prototype);
if((G__35861__$1 == null)){
return null;
} else {
return G__35861__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35862 = c;
var G__35862__$1 = (((G__35862 == null))?null:G__35862.prototype);
if((G__35862__$1 == null)){
return null;
} else {
return G__35862__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__35864 = c;
var G__35864__$1 = (((G__35864 == null))?null:G__35864.constructor);
if((G__35864__$1 == null)){
return null;
} else {
return G__35864__$1.displayName;
}
})();
...
var G__35865 = c;
var G__35865__$1 = (((G__35865 == null))?null:G__35865.constructor);
if((G__35865__$1 == null)){
return null;
} else {
return G__35865__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__35866 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35867 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35867);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35866);
}});
...
var c = this;
var G__35870_35891 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__35870_35891 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35870_35891);
}
...
var renders_35892 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_35893 = cljs.core.first(cljs.core.vals(renders_35892));
...
if((cljs.core.count(renders_35892) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_35892))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_35893)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_35893], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__35871 = o;
reagent.impl.component.goog$module$goog$object.set(G__35871,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__35872 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35873 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35873);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35872);
}});
...
var vec__35874 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35874,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35874,(1),null);
...
var G__35877 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__35877 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__35877);
}
});
}),[]);
