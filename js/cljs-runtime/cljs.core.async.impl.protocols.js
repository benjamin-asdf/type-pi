...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_35849 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_35849(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_35852 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_35852(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_35860 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_35860(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_35861 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_35861(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_35866 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_35866(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_35873 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_35873(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_35889 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_35889(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_35899 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_35899(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_35901 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_35901(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_35922 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_35922(b);
}
});
