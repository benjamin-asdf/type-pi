...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_56214 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_56214(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_56215 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_56215(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_56216 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_56216(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_56217 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_56217(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_56218 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_56218(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_56219 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_56219(reader);
}
});
...
var G__56228 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__56229 = s.append(c);
c = G__56228;
s = G__56229;
continue;
}
