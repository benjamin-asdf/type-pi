...
var G__35901 = o;
reagent.impl.template.goog$module$goog$object.set(G__35901,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__35921__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__35921 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__35922__i = 0, G__35922__a = new Array(arguments.length -  0);
while (G__35922__i < G__35922__a.length) {G__35922__a[G__35922__i] = arguments[G__35922__i + 0]; ++G__35922__i;}
  args = new cljs.core.IndexedSeq(G__35922__a,0,null);
} 
return G__35921__delegate.call(this,args);};
G__35921.cljs$lang$maxFixedArity = 0;
G__35921.cljs$lang$applyTo = (function (arglist__35923){
var args = cljs.core.seq(arglist__35923);
return G__35921__delegate(args);
});
...
var G__35902 = o;
reagent.impl.template.goog$module$goog$object.set(G__35902,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__35927__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__35928__i < G__35928__a.length) {G__35928__a[G__35928__i] = arguments[G__35928__i + 0]; ++G__35928__i;}
  args = new cljs.core.IndexedSeq(G__35928__a,0,null);
} 
return G__35927__delegate.call(this,args);};
G__35927.cljs$lang$maxFixedArity = 0;
G__35927.cljs$lang$applyTo = (function (arglist__35929){
var args = cljs.core.seq(arglist__35929);
...
var G__35903 = props;
var G__35903__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35903,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__35903);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35903__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__35904 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35904,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__35904;
}
})(),id_class);
...
var G__35905 = (cljs.core.count(argv) - first_child);
switch (G__35905) {
case (0):
...
var vec__35906 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35906,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35906,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35906,(2),null);
...
var temp__5827__auto___35944 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___35944 == null)){
} else {
var key_35945 = temp__5827__auto___35944;
(jsprops.key = key_35945);
}
...
var temp__5827__auto___35948 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___35948 == null)){
} else {
var key_35949 = temp__5827__auto___35948;
(jsprops.key = key_35949);
}
...
var temp__5827__auto___35950 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___35950 == null)){
} else {
var key_35951 = temp__5827__auto___35950;
(jsprops.key = key_35951);
}
...
var temp__5827__auto___35961 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___35961 == null)){
} else {
var key_35963 = temp__5827__auto___35961;
(jsprops.key = key_35963);
}
...
var temp__5827__auto___35964 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___35964 == null)){
} else {
var key_35965 = temp__5827__auto___35964;
(jsprops.key = key_35965);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35909_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__35909_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__35910 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35910,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35910,(1),null);
...
break;
default:
var G__35969 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__35970 = compiler;
v = G__35969;
compiler = G__35970;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template35916 = (function (opts,id,fn_to_element,parse_fn,meta35917){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template35916.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_35918,meta35917__$1){
var self__ = this;
var _35918__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template35916(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta35917__$1));
}));

(reagent.impl.template.t_reagent$impl$template35916.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_35918){
var self__ = this;
var _35918__$1 = this;
return self__.meta35917;
}));

(reagent.impl.template.t_reagent$impl$template35916.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template35916.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template35916.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template35916.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template35916.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template35916.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta35917","meta35917",-634666493,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template35916.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template35916.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template35916");

(reagent.impl.template.t_reagent$impl$template35916.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template35916");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template35916.
 */
reagent.impl.template.__GT_t_reagent$impl$template35916 = (function reagent$impl$template$__GT_t_reagent$impl$template35916(opts,id,fn_to_element,parse_fn,meta35917){
return (new reagent.impl.template.t_reagent$impl$template35916(opts,id,fn_to_element,parse_fn,meta35917));
});
...
return (new reagent.impl.template.t_reagent$impl$template35916(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
